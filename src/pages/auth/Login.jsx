            ...
            <div className="grid p-0 md:grid-cols-2">
              ...
              <form className="p-8 md:p-12 flex flex-col justify-center" onSubmit={handleSubmit(onSubmit)}>
                <div className="flex flex-col items-center gap-2 text-center mb-8">
                  <h1 className="text-3xl font-extrabold text-zap-dark">Welcome back</h1>
                  <p className="text-gray-500">
                    Login to your ParCelGo account
                  </p>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="form-control w-full">
                    <div className="flex items-center justify-between px-1 py-2">
                      ...
                      <a href="#" className="text-sm text-gray-500 underline-offset-2 hover:underline hover:text-zap-dark transition-colors">
                  ...
                  <button 
                    type="submit" 
                    disabled={loading}
                    className="btn w-full bg-zap-dark hover:bg-black text-white rounded-xl h-12 text-lg font-semibold border-none mt-4"
                  >
                    {loading ? <span className="loading loading-spinner"></span> : 'Login'}
                  </button>
                </div>
                
                <div className="divider text-gray-400 text-sm my-8">Or continue with</div>
                ...
                <p className="mt-8 text-center text-sm text-gray-600">
                  ...
                  <Link to="/register" className="font-bold text-zap-dark hover:text-zap-green transition-colors underline underline-offset-4">
                    Sign up
                  </Link>
                </p>
              </form>
              ...
              {/* Image Section */}
              <div className="relative hidden md:block bg-zinc-100 p-8 flex items-center justify-center">
                <div className="absolute inset-0 bg-zap-dark/5 z-0"></div>
                {/* Beautiful Abstract Background for the image side */}
                <div className="relative z-10 w-full h-full flex items-center justify-center">
                  <div className="w-full h-full rounded-2xl bg-gradient-to-br from-zap-green/30 to-zap-dark/10 backdrop-blur-sm border border-white/20 flex flex-col items-center justify-center p-8 text-center">
                     ...
                     <h3 className="text-2xl font-bold text-zap-dark mb-2">Track & Deliver</h3>
                     <p className="text-gray-600">Experience the fastest parcel delivery management system in the country.</p>
                  </div>
                </div>
                {/* Fallback image style similar to shadcn */}
                <img
